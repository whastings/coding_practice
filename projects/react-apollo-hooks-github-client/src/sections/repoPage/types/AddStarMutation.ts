...
export interface AddStarMutation_addStar_starrable_Topic {
...
export type AddStarMutation_addStar_starrable = AddStarMutation_addStar_starrable_Topic | AddStarMutation_addStar_starrable_Repository;

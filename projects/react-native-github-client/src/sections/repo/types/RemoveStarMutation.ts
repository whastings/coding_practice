...
export interface RemoveStarMutation_removeStar_starrable_Gist {
...
export type RemoveStarMutation_removeStar_starrable = RemoveStarMutation_removeStar_starrable_Gist | RemoveStarMutation_removeStar_starrable_Repository;
